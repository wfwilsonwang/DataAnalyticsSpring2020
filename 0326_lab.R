...
# overweight variables that happen to have the larger values. # Read the documentation of scale() function in RStudio.
help(scale)
...
# You can see that we can choose to have 8 variables from the total of 13 
# (choosing 8 out of 13) with only about 8% of loss of cumulative contribution value.
